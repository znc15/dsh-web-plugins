/**
 * Same-origin fence for the deletion route. Mirrors the family fence in
 * skin-center/http-utils: a cross-site browser fetch is rejected (Sec-Fetch-
 * Site or a mismatched Origin), while curl / node clients without those
 * headers pass — the fence only targets the cross-site browser vector.
 */
